const config = {
	...
	metaData: {
		title: '群仔的个人主页🎉',
		description: '欢迎来到群仔的奇妙世界！',
		keywords: '群仔,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/头像.jpg", // 头像
	welcometitle: "スカート", // 标题
	...
	background: {
		...
		"mobile": {   //移动端
			...
			"datainfo": {
				...
				"url": "/img/wallpaper/static/主页壁纸.jpg"  //同理，随机移动端壁纸："url":"https://t.mwm.moe/mp"
			}
		}
	...
	musicPlayer: {
		...
		type: 'playlist',   //歌单类型
		id: '14467871010'  //歌单id ---> music.163.com/#/playlist?id=2028178887
	},
	...
	projectcards: [
		{ go: "🚀 前往1", img: "/img/sunshine.jpg", title: "Project 1", subtitle: "1,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: true },
		{ go: "🗂️ 前往", img: "/img/sunshine.jpg", title: "Project 2", subtitle: "2,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: true },
		{ go: "📝 前往", img: "/img/sunshine.jpg", title: "Project 3", subtitle: "3,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: true },
		{ go: "👍 前往", img: "/img/sunshine.jpg", title: "Project 4", subtitle: "4,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://leleo.top", show: true },
